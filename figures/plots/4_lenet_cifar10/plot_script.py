...
DATA_PATH = '/ht_nns/results_saved/lenet_cifar10/'
...
def get_plots(final_alphas, ratio, perc, dataset, model, cmap='viridis'):
    ...
    fig.savefig(
        '/Users/krunoslavlehmanpavasovic/PycharmProjects/heavy_tails_new/plots_png_output/4_lenet_cifar10/plot.png')
    fig.savefig(
        '/Users/krunoslavlehmanpavasovic/PycharmProjects/heavy_tails_new/plots_pdf_output/4_lenet_cifar10/plot.pdf')


if __name__ == '__main__':
    folder = '2023-03-25_10_37_30.070119'
    # best 2023-03-25_10_37_30.070119
